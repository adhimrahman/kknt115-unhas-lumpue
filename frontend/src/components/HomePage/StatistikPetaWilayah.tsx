...
type StatKey = "luas_wilayah" | "jumlah_rt" | "jumlah_rw" | "total_penduduk";
...
const statCards: Array<{
	...
	{ key: "total_penduduk", fallbackLabel: "Total Penduduk", icon: Users }
];

export default function StatistikPetaWilayah() {
	const statByKey = new Map(mockStatistikItem.map((x) => [x.key, x]));
	...
	const batasWilayah = mockStatistikItem
		.filter((x) => x.key.startsWith("batas_"))
			...
			<section className="py-20 bg-linear-to-br from-[#1E293B] to-[#2D3E56]">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<div className="w-24 h-1 bg-[#4D9AE1] mx-auto" />
					</div>
			...
			<section className="py-20 bg-gray-50">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<div className="w-24 h-1 bg-[#4D9AE1] mx-auto mb-4" />
